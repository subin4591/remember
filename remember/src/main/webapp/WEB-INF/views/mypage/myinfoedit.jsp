		...
		<div class="my_content">
			...
			<div class="myinfo">
				<form id="editForm" action="/myinfoedit" method="POST">
					<div class='myedit'>
						<p>아이디</p>
						<input type="text" name="memId" id="memId" value="${user.id }"
							disabled>
					</div>
					<div class='myedit'>
						<p>비밀번호*</p>
						<input type="password" name="memPw" id="memPw"
							value="${user.password }" maxlength="16"> <a class="help">(영문
							대소문자/숫자/특수문자 중 2가지 이상 조합, 8자~16자)</a>
					</div>
					<div class='myedit'>
						<p>비밀번호 확인*</p>
